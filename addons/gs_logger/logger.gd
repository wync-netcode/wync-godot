...
func info(message, category : String = CATEGORY_GENERAL):
	_append(LOG_LEVEL_INFO, message, category)


#Function: fine
#	Log a Message at a Fine level.
func fine(message, category : String = CATEGORY_GENERAL):
	_append(LOG_LEVEL_FINE, message, category)


#Function: trace
#	Log a Message at a Trace level.
func trace(message, category : String = CATEGORY_GENERAL):
	_append(LOG_LEVEL_TRACE, message, category)


#Function: debug
#	Log a Message at a Trace level.
func debug(message, category : String = CATEGORY_GENERAL):
	_append(LOG_LEVEL_DEBUG, message, category)


#Function: warn
#	Log a Warning Message.
func warn(message, category : String = CATEGORY_GENERAL):
	_append(LOG_LEVEL_WARN, message, category)


#Function: error
#	Log an Error Message.
func error(message, category : String = CATEGORY_GENERAL):
	_append(LOG_LEVEL_ERROR, message, category) 


#Function: fatal
#	Log an Error Message.
func fatal(message, category : String = CATEGORY_GENERAL):
